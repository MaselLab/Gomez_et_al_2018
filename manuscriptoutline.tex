...
\begin{table*}[b]
    ...
    \hline
	\end{tabular}
	\caption{Population parameters measured in evolution experiments for key microorganisms. Beneficial mutation rates are given.} 
	\label{Table 1}
\end{table}
...
\begin{enumerate}
\item What are the changes to variance trait one and its covariance with trait two? 
\item Which of them is responsible for the reduction of adaptation and to what degree?
\item How does variance of the trait and its covariance behave over time?
\end{enumerate}
