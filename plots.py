...
my_xticks = [(min_par + i*(max_par-min_par)/5.0) for i in range(6)]
my_xlabel = [1e2*my_xticks[i] for i in range(len(my_xticks))]
...
plt.annotate('(a)',xy=(105,475),xycoords='figure points',fontsize=20)
...
my_xticks = [(min_par + i*(max_par-min_par)/5.0) for i in range(6)]
my_xlabel = [1e5*my_xticks[i] for i in range(len(my_xticks))]
my_yticks = [20*i for i in range(9)]
my_ylabel = ['']+[str(20*(i+1))+'%' for i in range(9)]
...
plt.xticks(my_xticks,my_xlabel)
plt.yticks(my_yticks,my_ylabel)
plt.annotate(r'$\times 10^{-5}$',xy=(505,20),xycoords='figure points',fontsize=20)
plt.annotate('(b)',xy=(105,475),xycoords='figure points',fontsize=20)
ax2e.grid(b='off', which='both', axis='both')
#ax2e.ticklabel_format(style='plain',axis='x')
ax2e.set_ylim((0,160))
ax2e.set_xlim((min_par,max_par))  
ax2e.legend(loc=4,ncol=2,fontsize=16)        
...
my_xticks = [(min_par + i*(max_par-min_par)/5.0) for i in range(6)]
my_xlabel = [np.round(1e-8*my_xticks[i],2) for i in range(len(my_xticks))]
my_yticks = [20*i for i in range(9)]
my_ylabel = ['']+[str(20*(i+1))+'%' for i in range(9)]
...
plt.xticks(my_xticks,my_xlabel)
plt.yticks(my_yticks,my_ylabel)
plt.annotate(r'$\times 10^{8}$',xy=(505,20),xycoords='figure points',fontsize=20)
plt.annotate('(c)',xy=(105,475),xycoords='figure points',fontsize=20)
ax2f.grid(b='off', which='both', axis='both')
#ax2f.ticklabel_format(style='plain',axis='x')
ax2f.set_ylim((0,160))
ax2f.set_xlim((min_par,max_par)) 
ax2f.legend(loc=4, ncol=2,fontsize=16)        
...
plt.xticks(my_xticks,my_xlabel)
plt.yticks(my_yticks,my_ylabel)
plt.annotate('(d)',xy=(105,475),xycoords='figure points',fontsize=20) 
ax2g.grid(b='off', which='both', axis='both')
ax2g.set_ylim((20,80))
ax2g.set_xlim(0,10) 
ax2g.legend(loc=4,ncol=2,fontsize=14)        
