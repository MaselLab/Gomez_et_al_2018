...
ax.plot(xs,Vars,c="darkcyan",linewidth=3.0,linestyle = '-')
ax.plot(xs,Covs,c="magenta",linewidth=3.0,linestyle = '-')
ax.scatter(ps,Vs-Cs,c="blue",label='$v_{1}$ sim',s=40.0,marker = 'o')        
ax.scatter(ps,Vs,c="darkcyan",label='$\sigma_1^2$ sim',s=40.0,marker = 'D')
...
ax.plot(xU,VarU,c="darkcyan",label='$\sigma_{1}^2$ theory',linewidth=3.0,linestyle = '-')
...
ax.scatter(pU,VU,c="darkcyan",label='$\sigma_1^2$',s=40.0,marker = 'D')
...
ax.plot(xN,VarN,c="darkcyan",label='$\sigma_{1}^2$ theory',linewidth=3.0,linestyle = '-')
...
ax.scatter(pN,VN,c="darkcyan",label='$\sigma_1^2$',s=40.0,marker = 'D')
