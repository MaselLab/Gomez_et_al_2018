...
ax.scatter(ps,Vs,c="darkcyan",label='$\sigma_1^2$ sim',s=40.0,marker = 'o')
...
ax.scatter(pU,VU,c="darkcyan",label='$\sigma_1^2$',s=40.0,marker = 'o')
...
ax.scatter(pN,VN,c="darkcyan",label='$\sigma_1^2$',s=40.0,marker = 'o')
